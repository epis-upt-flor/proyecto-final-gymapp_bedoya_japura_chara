...
import com.example.proyectogym.databinding.ActivityAdd3Binding
...
class AddActivity3 : AppCompatActivity() {
    ...
    private lateinit var bindingActivityAdd: ActivityAdd3Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bindingActivityAdd = ActivityAdd3Binding.inflate(layoutInflater)
        ...
        bindingActivityAdd.saveButton.setOnClickListener {
            ...
            if(fileUri==null){
                val mVideoGame = ControllerProductos(name, date, price, description)
